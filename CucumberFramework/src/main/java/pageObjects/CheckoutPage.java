...
public class CheckoutPage {
	...
	//@FindBy(how = How.XPATH, using = "//[@id=\"noo-site\"]/div[2]/div/div/div/div/div/div/div/div[2]/div/p[1]") 
	//private WebElement txt_OrderConfirmationMsg;
	...
	public void enter_City(String city) {
		...
		System.out.println("CheckoutPage - Session ID for chrome browser........" + txtbx_City);
	}
	
	public void enter_Address(String address) {
		txtbx_Address.sendKeys(address);
		System.out.println("CheckoutPage - Session ID for chrome browser........" + txtbx_Address);
	}
	...
	public void select_Country(String countryName) {
		...
		for(WebElement country : country_List){
			System.out.println("CheckoutPage - CountryName........" + countryName + " ");
			if(country.getText().equals(countryName)) {
				System.out.println("CheckoutPage - Country........" + country.getText() + " ");
				country.click();	
				try { Thread.sleep(3000);}
				catch (InterruptedException e) {}
				break;
